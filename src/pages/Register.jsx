      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ marginTop: "8px", fontSize: "13px", fontWeight: "400", opacity: 0.85 }}>
            Create an account to manage your documents and generate AI summaries
          </p>
        </div>

        {/* FORM */}
        <div style={{ padding: "32px 24px" }}>
          <h2 style={{ textAlign: "center", marginBottom: "24px", color: "#1e293b", fontSize: "20px", fontWeight: "700" }}>Create account</h2>
          ...
          <form onSubmit={handleRegister} style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
            <div>
              ...
              <input
                ...
                onBlur={e => { e.target.style.borderColor = "#f3e8ff"; e.target.style.boxShadow = "none"; }}
                required
              />
            </div>
            <div>
          ...
          <p style={{ textAlign: "center", fontSize: "13px", color: "#6b7280", marginTop: "24px" }}>
            Already have an account? <Link to="/" style={{ color: "#8b5cf6", fontWeight: "600", textDecoration: "none" }}>Login</Link>
          </p>
        </div>
      </div>
    </div>
